...
> [!TIP]
> This repository features a **modular, automated setup script** for fresh macOS installs.

### Automated Installation (New Mac)

1. **Install Xcode Command Line Tools** (Provides Apple Git)
   ```bash
